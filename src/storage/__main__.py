...
def main():
    ...
    for report in bug_reports:
        try:
            # 生成各个字段的向量
            vectors = {
                "summary_vector": vectorizer.summary_vectorizer.vectorize(report.get("summary", "")),
                "code_vector": vectorizer.code_vectorizer.vectorize(report.get("code", "")),
                ...
                "log_info_vector": vectorizer.log_vectorizer.vectorize(report.get("log_info", "")),
                "environment_vector": vectorizer.environment_vectorizer.vectorize(report.get("environment", ""))
            }
